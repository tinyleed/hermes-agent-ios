...
- The gateway-backed approval/sudo/secret blocking-card loop is proven end-to-end in the simulator against the safe mock WebSocket gateway.
...
- Physical-device proof for gateway-backed blocking requests is still pending.
